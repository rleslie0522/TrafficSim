...
class TrainRobot(Robot):
    def __init__(self, name: str, id: int, executor: Executor, station_graph: StationGraph, current_station_name: str, speed_mult: float, **kwargs):
        super().__init__(name, **kwargs)
        self.startup_node(id, executor, station_graph, current_station_name, speed_mult)

    def startup_node(self, id: int, executor: Executor, station_graph: StationGraph, current_station_name: str, speed_mult: float):
        self.node = TrainController(self.name, id, self, station_graph, current_station_name, speed_mult)
