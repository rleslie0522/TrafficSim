...
class PathFollower:
    ...
    def get_next_pose(self, dt: float) -> Pose:
        dist_to_move = max(min(SPEED * dt, self.total_distance - self.distance_traveled), 0)
    ...
    def __repr__(self) -> str:
        return f"PathFollower(current_pos={self.current_pos}, total_distance={self.total_distance}, direction={self.direction}, distance_traveled={self.distance_traveled})"
